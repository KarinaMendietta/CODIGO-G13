#necesuto instalar requests y beautifulSoup el bs4 asi lo instalo
#https://www.sbs.gob.pe/app/pp/sistip_portal/paginas/publicacion/tipocambiopromedio.aspx
# de esa pagina haremos el scrapping
import requests
...
if(url.status_code == 200):
    #print(url.text)  #lo ejecuto y veo que ya la tengo, primero probe asi, ahora lo dejo en comentario
